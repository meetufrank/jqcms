...
-- ----------------------------
-- Table structure for clt_dreply
-- ----------------------------
DROP TABLE IF EXISTS `clt_dreply`;
CREATE TABLE `clt_dreply` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
  `listorder` int(10) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of clt_dreply
-- ----------------------------
INSERT INTO `clt_dreply` VALUES ('8', '0', '', '0', '1537434007', '0', '0', '0', '1', '2', '是吗是吗是吗', '1');
INSERT INTO `clt_dreply` VALUES ('7', '0', '', '0', '1537424087', '0', '0', '0', '1', '1', 'test', '2');
INSERT INTO `clt_dreply` VALUES ('6', '0', '', '0', '1537423635', '1537435049', '0', '0', '1', '1', 'test', '1');
INSERT INTO `clt_dreply` VALUES ('9', '0', '', '0', '1537434020', '0', '0', '0', '1', '1', '是的是的是的', '1');
INSERT INTO `clt_dreply` VALUES ('12', '0', '', '0', '1537438610', '0', '0', '0', '1', '2', '？？？？？？？？？？？？？？？？？？？？？？？？？？', '2');
INSERT INTO `clt_dreply` VALUES ('13', '0', '', '0', '1537438650', '0', '0', '0', '0', '1', '是的是的是的是的', '2');

-- ----------------------------
-- Table structure for clt_emailbox
-- ----------------------------
DROP TABLE IF EXISTS `clt_emailbox`;
CREATE TABLE `clt_emailbox` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `clt_field` VALUES ('438', '53', 'type', '消息类型', '', '1', '0', '0', 'defaul', '', 'type', 'radio', 'array (\n  \'options\' => \'回复|1\n追问|2\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'default\' => \'1\',\n)', '0', '', '1', '1', '0');
