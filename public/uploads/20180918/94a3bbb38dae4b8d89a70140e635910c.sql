...
INSERT INTO `clt_auth_group` VALUES ('2', '管理员', '1', '0,1,267,269,', '1465114224');
...
INSERT INTO `clt_auth_rule` VALUES ('325', 'Meeting', '会议管理', '1', '1', '1', 'icon-briefcase', '', '0', '4', '1529638188', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('323', 'Tag/index', '动态标签', '1', '1', '1', '', '', '320', '3', '1523503551', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('313', 'Company', '公司管理', '1', '1', '1', 'icon-user-tie', '', '0', '5', '1522812276', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('314', 'Company/index', '公司列表', '1', '1', '1', '', '', '313', '1', '1522812393', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('324', 'business/index', '业务管理', '1', '1', '1', '', '', '320', '4', '1523931833', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('322', 'opratelog/index', '操作日志', '1', '1', '1', '', '', '320', '2', '1523417121', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('321', 'language/index', '语言管理', '1', '1', '1', '', '', '320', '1', '1523417046', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('320', 'other', '其他管理', '1', '1', '1', 'icon-windows8', '', '0', '4', '1523416939', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('328', 'Cclient', 'C9管理', '1', '1', '1', 'icon-video-camera', '', '0', '4', '1530087081', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('327', 'PexipMeeting/index', 'pexip会议管理', '1', '1', '1', '', '', '325', '1', '1529641108', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('329', 'Cclient/index', 'C9设备管理', '1', '1', '1', '', '', '328', '1', '1530087187', null, '1');

-- ----------------------------
-- Table structure for clt_business
-- ----------------------------
DROP TABLE IF EXISTS `clt_business`;
CREATE TABLE `clt_business` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of clt_business
-- ----------------------------
INSERT INTO `clt_business` VALUES ('1', '提交case', '1', '0', '', '0', '1523931896', '0', '0', '0', '1', '2');
INSERT INTO `clt_business` VALUES ('2', '提交case', '1', '0', '', '0', '1523933558', '0', '0', '0', '1', '1');
...
-- ----------------------------
-- Table structure for clt_cclient
-- ----------------------------
DROP TABLE IF EXISTS `clt_cclient`;
CREATE TABLE `clt_cclient` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL DEFAULT '',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of clt_cclient
-- ----------------------------
INSERT INTO `clt_cclient` VALUES ('4', 'wang jin', '1', '0', '', '0', '1530090563', '0', '0', '0', '1', '172.32.65.176');
...
-- ----------------------------
INSERT INTO `clt_company` VALUES ('1', '测试', '1', '0', '', '0', '1522836351', '0', '1523248008', '0', '1', '0', 'AM', '25ec916d56b8212e569dbf2e4e4b51d4', '25ec916d56b8212e569dbf2e4e4b51d4');
INSERT INTO `clt_company` VALUES ('2', '测试', '1', '0', '', '0', '1523248145', '0', '0', '0', '1', '0', 'AMGB', 'fdba35db7217100d591b983da9c63074', 'fdba35db7217100d591b983da9c63074');
INSERT INTO `clt_company` VALUES ('3', '测试公司', '1', '0', '', '0', '1523248269', '0', '0', '0', '1', '0', 'AMG', '797a8c14d48d1f184dfcb43af0fea3fa', 'e7da08da54a02a0a560c62bcd86fcaf9');
...
INSERT INTO `clt_field` VALUES ('368', '44', 'name', '名称', '', '1', '1', '80', 'defaul', '标题必须为1-80个字符', 'title', 'title', 'array (\n  \'thumb\' => \'0\',\n  \'style\' => \'0\',\n)', '1', '', '2', '1', '1');
INSERT INTO `clt_field` VALUES ('370', '44', 'createtime', '发布时间', '', '1', '0', '0', 'date', '', '', 'datetime', '', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('371', '44', 'is_open', '开启状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'开启|1\r\n禁用|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('372', '44', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '98', '1', '1');
INSERT INTO `clt_field` VALUES ('374', '44', 'casetype', 'Case类型权限', '', '1', '0', '0', 'defaul', '', 'casetype', 'checkbox_db', 'array (\n  \'db\' => \'casetype\',\n  \'name\' => \'Y29uY2F0KCd0eXBlbmFtZScsJygnLHR5cGVlbmFtZSwnKScp\',\n  \'value\' => \'id\',\n  \'where\' => \'eyJkZWxldGV0aW1lIjowfQ==\',\n  \'fieldtype\' => \'varchar\',\n  \'numbertype\' => \'\',\n  \'default\' => \'\',\n)', '0', '', '4', '1', '0');
INSERT INTO `clt_field` VALUES ('375', '44', 'company', '所属公司', '', '1', '0', '0', 'defaul', '', 'company', 'customize', 'array (\n  \'content\' => \'\',\n  \'fieldtype\' => \'mediumint\',\n  \'numbertype\' => \'\',\n  \'default\' => \'\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('381', '46', 'name', '语言名称', '', '1', '1', '80', 'defaul', '标题必须为1-80个字符', 'name', 'title', 'array (\n  \'thumb\' => \'0\',\n  \'style\' => \'0\',\n)', '1', '', '2', '1', '1');
INSERT INTO `clt_field` VALUES ('412', '50', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '98', '1', '1');
INSERT INTO `clt_field` VALUES ('411', '50', 'is_open', '开启状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'开启|1\r\n禁用|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('413', '50', 'ip_address', '设备IP地址', '', '1', '0', '0', 'ip4', '', 'ip_address', 'text', 'array (\n  \'default\' => \'\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('410', '50', 'createtime', '发布时间', '', '1', '0', '0', 'date', '', '', 'datetime', '', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('408', '50', 'name', '设备名称', '', '1', '1', '80', 'cn_username', '标题必须为1-80个字符', 'title', 'title', 'array (\n  \'thumb\' => \'0\',\n  \'style\' => \'0\',\n)', '1', '', '2', '1', '1');
...
INSERT INTO `clt_field` VALUES ('405', '49', 'createtime', '发布时间', '', '1', '0', '0', 'date', '', '', 'datetime', '', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('406', '49', 'is_open', '开启状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'开启|1\r\n禁用|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('407', '49', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '98', '1', '1');
INSERT INTO `clt_field` VALUES ('390', '44', 'language', '默认语言', '', '1', '0', '0', 'defaul', '', 'language', 'select_db', 'array (\n  \'multiple\' => \'0\',\n  \'db\' => \'language\',\n  \'name\' => \'bmFtZQ==\',\n  \'value\' => \'id\',\n  \'where\' => \'eyJkZWxldGV0aW1lIjowfQ==\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'size\' => \'\',\n  \'default\' => \'\',\n)', '0', '', '5', '1', '0');
INSERT INTO `clt_field` VALUES ('403', '49', 'title', '标题', '', '1', '1', '80', '', '标题必须为1-80个字符', '', 'title', 'array (\n  \'thumb\' => \'1\',\n  \'style\' => \'1\',\n  \'size\' => \'55\',\n)', '1', '', '2', '1', '1');
INSERT INTO `clt_field` VALUES ('404', '49', 'hits', '点击次数', '', '0', '0', '8', '', '', '', 'number', 'array (\n  \'size\' => \'10\',\n  \'numbertype\' => \'1\',\n  \'decimaldigits\' => \'0\',\n  \'default\' => \'0\',\n)', '1', '', '8', '0', '0');
INSERT INTO `clt_field` VALUES ('391', '47', 'name', '标签名称', '', '1', '1', '80', 'defaul', '标题必须为1-80个字符', 'name', 'title', 'array (\n  \'thumb\' => \'0\',\n  \'style\' => \'0\',\n)', '1', '', '2', '1', '1');
INSERT INTO `clt_field` VALUES ('396', '47', 'content', '标签内容', '', '1', '0', '0', 'defaul', '', 'content', 'textarea', 'array (\n  \'fieldtype\' => \'mediumtext\',\n  \'default\' => \' \',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('393', '47', 'createtime', '发布时间', '', '1', '0', '0', 'date', '', '', 'datetime', '', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('394', '47', 'is_open', '开启状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'开启|1\r\n禁用|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('395', '47', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '98', '1', '1');
INSERT INTO `clt_field` VALUES ('397', '48', 'name', '名称', '', '1', '1', '80', 'defaul', '标题必须为1-80个字符', 'name', 'title', 'array (\n  \'thumb\' => \'0\',\n  \'style\' => \'0\',\n)', '1', '', '2', '1', '1');
INSERT INTO `clt_field` VALUES ('402', '48', 'type', '业务类型', '', '1', '0', '0', 'defaul', '', 'type', 'radio', 'array (\n  \'options\' => \'短信|1\n邮件|2\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'default\' => \'2\',\n)', '0', '', '3', '1', '0');
INSERT INTO `clt_field` VALUES ('399', '48', 'createtime', '发布时间', '', '1', '0', '0', 'date', '', '', 'datetime', '', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('400', '48', 'is_open', '开启状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'开启|1\r\n禁用|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '97', '1', '1');
INSERT INTO `clt_field` VALUES ('401', '48', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)', '1', '', '98', '1', '1');
...
INSERT INTO `clt_module` VALUES ('44', 'patient portal模型', 'patients', '公司的patient  portal', '1', '0', '*', '', '0', '1');
INSERT INTO `clt_module` VALUES ('49', '会议模型', 'pexipmeeting', '', '1', '0', '*', '', '0', '1');
INSERT INTO `clt_module` VALUES ('50', 'C9设备表', 'cclient', '', '1', '0', '*', '', '0', '1');
INSERT INTO `clt_module` VALUES ('46', '语言模型', 'language', '', '1', '0', '*', '', '0', '1');
INSERT INTO `clt_module` VALUES ('47', '动态标签模型', 'tag', '信息动态 标签模型', '1', '0', '*', '', '0', '1');
INSERT INTO `clt_module` VALUES ('48', '业务模型', 'business', '业务模块', '1', '0', '*', '', '0', '1');

-- ----------------------------
-- Table structure for clt_opratelog
-- ----------------------------
DROP TABLE IF EXISTS `clt_opratelog`;
CREATE TABLE `clt_opratelog` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '//编号',
  `title` varchar(255) NOT NULL COMMENT '//日志内容',
  `time` int(11) NOT NULL COMMENT '//操作时间',
  `optateid` varchar(255) NOT NULL COMMENT '//操作数据编号',
...
INSERT INTO `clt_page` VALUES ('8', '联系我们', 'color:;font-weight:normal;', '', '0', '1', '0', '', '0', '1499765407', '0', '0', '<p>您的支持是我们一往{$username}无前的无限动力，非常荣幸在<a target=\"_self\" href=\"http://www.cltphp.com/\">CLTPHP</a>成长的道路上有您的陪伴！！！</p>');

-- ----------------------------
-- Table structure for clt_patients
-- ----------------------------
DROP TABLE IF EXISTS `clt_patients`;
CREATE TABLE `clt_patients` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL DEFAULT '',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of clt_patients
-- ----------------------------
INSERT INTO `clt_patients` VALUES ('3', '测试111', '1', '0', '', '0', '1523353294', '1523353329', '0', '0', '1', '9', '3', '1');
INSERT INTO `clt_patients` VALUES ('4', '测试2222', '1', '0', '', '0', '1523353350', '0', '0', '0', '1', '9', '2', '1');
...
INSERT INTO `clt_pay_order` VALUES ('13', '1', '2018031448551009', null, '0.01', '0', '1521011888', '0', null, '0.00', '0.00', '0.00', '0.00', '0', '0', '', '0');
INSERT INTO `clt_pay_order` VALUES ('14', '1', '2018031410110251', null, '0.01', '0', '1521011967', '0', null, '0.00', '0.00', '0.00', '0.00', '0', '0', '', '0');

-- ----------------------------
-- Table structure for clt_pexipmeeting
-- ----------------------------
DROP TABLE IF EXISTS `clt_pexipmeeting`;
CREATE TABLE `clt_pexipmeeting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(120) NOT NULL DEFAULT '',
  `title_style` varchar(225) NOT NULL DEFAULT '',
  `thumb` varchar(225) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Table structure for clt_tag
-- ----------------------------
DROP TABLE IF EXISTS `clt_tag`;
CREATE TABLE `clt_tag` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL DEFAULT '',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
...
-- Records of clt_tag
-- ----------------------------
INSERT INTO `clt_tag` VALUES ('1', '用户名', '1', '0', '', '0', '1523503746', '1523521359', '0', '0', '1', '{$username}');
INSERT INTO `clt_tag` VALUES ('2', '昵 称', '1', '0', '', '0', '1523945199', '1523945652', '0', '0', '1', ' {$nickname}');
INSERT INTO `clt_tag` VALUES ('3', '性 别', '1', '0', '', '0', '1523945487', '1523945643', '0', '0', '1', '{$sex}');
